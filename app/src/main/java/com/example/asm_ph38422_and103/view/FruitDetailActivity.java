...
import com.example.asm_ph38422_and103.adapter.ImageAdapter;
import com.example.asm_ph38422_and103.databinding.ActivityFruitDetailBinding;
...
//                .into(binding.img);
        ...
        binding.rcvImg.setLayoutManager(layoutManager);
